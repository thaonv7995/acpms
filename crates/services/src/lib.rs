...
#[path = "openclaw-admin-service.rs"]
pub mod openclaw_admin_service;
...
pub use openclaw_admin_service::{
    ConsumeOpenClawBootstrapTokenInput, CreateOpenClawBootstrapTokenInput,
    OpenClawAdminClientSummary, OpenClawAdminService, OpenClawAdminServiceError,
    OpenClawBootstrapPrompt, OpenClawEnrollmentResult,
};
...
pub use user::{
    is_hidden_user_email, UserDirectoryStats, UserListStatus, UserService,
