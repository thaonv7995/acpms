...
#[openapi(
    paths(
        ...
        routes::project_documents::list_project_documents,
        routes::project_documents::get_project_document,
        routes::project_documents::get_project_document_upload_url,
        routes::project_documents::create_or_upsert_project_document,
        routes::project_documents::update_project_document,
        routes::project_documents::delete_project_document,
        routes::project_documents::get_project_document_download_url,
    ...
    components(
        schemas(
            ...
            routes::project_documents::ProjectDocumentUploadUrlRequest,
            routes::project_documents::ProjectDocumentUploadUrlResponse,
            routes::project_documents::ProjectDocumentDownloadUrlRequest,
            routes::project_documents::ProjectDocumentDownloadUrlResponse,
            api::SprintDto,
            api::SprintResponse,
